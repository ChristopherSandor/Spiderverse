...
public class Collider {
    ...
    public Collider (int size){
        this.adjacencyList = new Dimension[size];
    }
    ...
    public void createCollider(String dimenisionFile, String peopleFile){
        ...
        Collider adjacencyList = new Collider(clusterObject.getAddedDimensions());
        adjacencyList.populateList(clusterObject);
        // Adds people:
        adjacencyList.addPeople(peopleFile);
        // Print Out:
        // adjacencyList.print("collider.out");
